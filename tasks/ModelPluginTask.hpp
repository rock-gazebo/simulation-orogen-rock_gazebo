...
namespace rock_gazebo {
     ...
     */
    class ModelPluginTask : public ModelPluginTaskBase, public ModelPluginTaskI
    {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class ModelPluginTaskBase;

    protected:

    public:
        /** TaskContext constructor for ModelPluginTask
         ...
         */
        void setGazeboPluginTaskName(std::string const& plugin_task_name);
    };
}
